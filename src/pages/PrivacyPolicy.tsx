...
export default function PrivacyPolicy() {
  return (
    <LegalLayout
      ...
      subtitle="How we collect, use, share, and protect your personal data on MotoHippi."
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-lg font-bold text-white mb-2">Introduction</h2>
          <p>
            This Privacy Policy describes how 9999207570 and its affiliates (collectively &quot;9999207570, we, our, us&quot;) collect, use, share, protect or otherwise process your information/ personal data through our website https://www.motohippi.com/ (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us.We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India. By visiting this Platform, providing your information or availing any product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be governed by the laws of India including but not limited to the laws applicable to data protection and privacy. If you do not agree please do not use or access our Platform.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-lg font-bold text-white mb-2">Security Precautions</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-white mb-2">Data Deletion and Retention</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-white mb-2">Consent</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-white mb-2">Changes to this Privacy Policy</h2>
          <p>
        ...
        <div className="p-5 rounded-xl bg-card/60 border border-white/10 space-y-2">
          <h2 className="text-lg font-bold text-white">Grievance Officer</h2>
          <p className="text-xs text-muted-foreground">Insert Name of the Office: </p>
          <p className="text-xs text-muted-foreground">Designation: </p>
          <p className="text-xs text-muted-foreground">Insert Name and Address of the Company: </p>
          <p className="text-xs text-muted-foreground">Contact us: </p>
          <p className="text-xs text-muted-foreground">Phone: Time: Monday - Friday(9:00 - 18:00)</p>
        </div>
      </div>
    </LegalLayout>
  );
