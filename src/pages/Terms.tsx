...
export default function Terms() {
  return (
    <LegalLayout
      ...
      subtitle="Please read these terms and conditions carefully before using our platform or services."
    >
      <div className="space-y-4">
        ...
        <p>
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.motohippi.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>

        <p>
          The Platform is owned by 9999207570, a company incorporated under the Companies Act, 1956 with its registered office at snn raj grandeurr (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..
        </p>
        ...
        <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 text-white font-semibold">
